...
.service('toaster', function ($rootScope) {
    ...
    this.removetoaster = function(type,title,body) {
     $rootScope.$broadcast('toaster-removeToast');
...
function ($compile, $timeout, toasterConfig, toaster) {
  return {
    ...
    link: function (scope, elm, attrs){
      ...
      scope.$on('toaster-removeToast',function () {
         if(!($.isEmptyObject(toaster.toast))){
             scope.removeToast(toaster.toast.id);             
           }
      })
    },
